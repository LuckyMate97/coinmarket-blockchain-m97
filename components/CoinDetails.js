...
const CoinDetails = ({ coinName, coinSymbol, price,marketCapValue,volumeValue,volumeCryptoValue,circulatingSupply,totalSupply,maxSupply,dilutedMarketCap,percentageChange }) => {
          ...
          <div className='-ml-16'>
            <div className={styles.coinRates}>
              <div>
                ...
                <div className='flex my-3'>
                  ...
                  <RateFilled percentageChange={percentageChange}/>
                </div>
            ...
            <div className={styles.coinInfo}>
              <div>
                ...
                <small> $ {marketCapValue.toFixed(2)}</small>
              ...
              <div className={styles.borderLeft}>
                ...
                <small>${dilutedMarketCap.toFixed(2)}</small>
                <Rate isIncrement={true} rate={0.53}  />
              </div>
              ...
              <div className={styles.borderLeft}>
                <div>
                  ...
                  <small>${volumeValue.toFixed(2)}</small>
                  <Rate isIncrement={true} rate={0.93}  />
                </div>
                <br />
                <div>
                  <div>
              ...
              <div className={styles.borderLeft}>
                <div>
                  ...
                  <small>{circulatingSupply.toFixed(2)} BTC</small>
                </div>
                <br />
                <div>
                  <div className={styles.flexBetween}>
                    ...
                    <div>
                     {maxSupply && maxSupply?( <small>{maxSupply.toFixed(2)}</small>): <></>}
                    </div>
                  </div>
                  <div className={styles.flexBetween}>
                    <div>
                    ...
                    <div>
                      <small>{totalSupply.toFixed(2)}</small>
                    </div>
                  </div>
                </div>
              </div>
